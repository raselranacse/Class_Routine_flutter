...
class Sunday extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(day2,style: TextStyle(color: Colors.black),),centerTitle: true,
        leading: IconButton(
      ...
      body: Container(
        child: Column(children: [
          Expanded(
            flex: 1,
            child: CustomContainer("Course: Operating System","Start time: 03:00 pm","Room No: 3103"),
          ),
          Expanded(
            flex: 1,
            child: CustomContainer("Course: Microprocessor","Start time: 05:00 pm","Room No: 3203"),
          ),
        ]),
      ),
    );
