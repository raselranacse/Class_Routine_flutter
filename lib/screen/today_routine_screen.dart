...
class TodayRoutineScreen extends StatefulWidget {
  @override
  _TodayRoutineScreenState createState() => _TodayRoutineScreenState();
}
...
class _TodayRoutineScreenState extends State<TodayRoutineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(today_routine,style: TextStyle(color: Colors.black),),centerTitle: true,
        leading: IconButton(
